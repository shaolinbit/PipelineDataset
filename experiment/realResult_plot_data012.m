...
%file_list{i}=fullfile(dir, 'fgo_results', 'data012', 'final_result.txt');
file_list{i}=fullfile(dir, 'fgo_results', 'data012', 'output.txt');
file_type_list(i)=1;
i=i+1;

%file_list{i}=fullfile(dir, 'EKF_results', 'data012','EKF', 'EKF_result_fwd.txt');
file_list{i}=fullfile(dir, 'EKF_results', 'data012', 'EKF_result_fwd.txt');
file_type_list(i)=4;
i=i+1;

%file_list{i}=fullfile(dir, 'EKF_results', 'data012','EKF', 'EKF_result_bwd.txt');
file_list{i}=fullfile(dir, 'EKF_results', 'data012', 'EKF_result_bwd.txt');
file_type_list(i)=4;
i=i+1;

%file_list{i}=fullfile(dir, 'EKF_results', 'data012','EKF', 'EKF_result_smooth.txt');
file_list{i}=fullfile(dir, 'EKF_results', 'data012', 'EKF_result_smooth.txt');
file_type_list(i)=4;
...
for i=1:length(file_list)
    ...
    elseif file_type_list(i)==2
        ...
        enu_list{i}=lla2enu(data_list{i}(:,[11 12 13]),blh0);
