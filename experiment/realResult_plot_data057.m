...
%file_list{i}=fullfile(dir, 'fgo_results', 'data057', 'final_result.txt');
file_list{i}=fullfile(dir, 'fgo_results', 'data057', 'output.txt');
file_type_list(i)=1;
i=i+1;

%file_list{i}=fullfile(dir, 'EKF_results', 'data057','EKF', 'EKF_result_fwd.txt');
file_list{i}=fullfile(dir, 'EKF_results', 'data057', 'EKF_result_fwd.txt');
file_type_list(i)=4;
i=i+1;

%file_list{i}=fullfile(dir, 'EKF_results', 'data057','EKF', 'EKF_result_bwd.txt');
file_list{i}=fullfile(dir, 'EKF_results', 'data057', 'EKF_result_bwd.txt');

file_type_list(i)=4;
i=i+1;

%file_list{i}=fullfile(dir, 'EKF_results', 'data057','EKF', 'EKF_result_smooth.txt');
file_list{i}=fullfile(dir, 'EKF_results', 'data057', 'EKF_result_smooth.txt');
